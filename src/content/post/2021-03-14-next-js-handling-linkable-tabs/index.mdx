...
<video controls style={{ width: "100%", height: "auto" }}>
  <source src={showing_off_tabs.src} type="video/mp4"/>
...
<video controls style={{ width: "100%", height: "auto" }}>
  <source src={tabs_going_back_nextjs.src} type="video/mp4"/>
  Your browser does not support the video tag.
</video>
...
<video controls style={{ width: "100%", height: "auto" }}>
  <source src={tabs_not_going_back_nextjs.src} type="video/mp4"/>
  Your browser does not support the video tag.
</video>
