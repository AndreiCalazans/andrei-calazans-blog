...
On I wrote about a <a href="#09-23-2022">useOnUpdated</a> hook which did not make use of useEffect and was more predictable. I have also started using a useOnMount hook with similar characteristics.
