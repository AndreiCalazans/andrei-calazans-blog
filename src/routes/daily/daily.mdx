...
_ps: eventually this will be split our by year or perhaps quarter, for now it's a single file._
...
**1) There are no reliable dev environment in the finance industry**
