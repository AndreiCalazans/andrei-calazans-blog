...
I recently saw a tweet from [Leandro Favre](https://twitter.com/FavreLeandrol) about directory.now.sh - a quick font search for expo-google-fonts.  He also has one for [icons](https://icons.expo.fyi) 
