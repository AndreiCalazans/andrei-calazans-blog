...
William and Christian [open sourced react-native-skia](https://github.com/Shopify/react-native-skia) sponsored by Spotify. [The release video made by William](https://www.youtube.com/watch?v=EHxEX78alZE) was amazing and he went over many capabilities that the library enables. 
