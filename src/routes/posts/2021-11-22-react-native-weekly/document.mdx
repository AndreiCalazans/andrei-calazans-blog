...
26e30a5ee9e Fix incorrect ViewFlattening for views that were listening for a JS event
34a5158ec81 Update Fabric to suport onEnter/onExit/onMove events
a9ccdcace53 Store metadata to determine if a view is listening for a JS event
44143b50fdc Update ViewConfigs to support onEnter/onExit/onMove events
...
Sota Ogo <sota@fb.com> adds a Fabric Component examples that takes a native View component and extends it to add a `callNativeMethodToChangeBackgroundColor` method.

See complete directory [here](https://github.com/facebook/react-native/tree/main/packages/rn-tester/NativeComponentExample)
