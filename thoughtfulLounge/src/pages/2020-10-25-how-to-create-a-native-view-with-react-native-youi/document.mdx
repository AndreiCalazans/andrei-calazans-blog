...
<img style={{ width: '100%' }} src={require('./rn_component_tree.png')} />

**Resulting Shadow Tree:**

<img style={{ width: '100%' }} src={require('./counterpart_shadow_tree.png')} />
...
<img style={{ width: '100%' }} src={require('./ShadowNodeSpec.png')} />


### ManagerModule Overview

<img style={{ width: '100%' }} src={require('./ManagerModuleSpec.png')} />
...
**Tip: You can always explore the available classes by looking inside ~/youiengine/<engine_versio>/include**
