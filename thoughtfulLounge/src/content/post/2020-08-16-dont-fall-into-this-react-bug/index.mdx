---
title: "Don't Fall Into This React Bug"
description: "React hooks introduced a new way to handle state, and it changed a specific mental model of what happens when we set state."
