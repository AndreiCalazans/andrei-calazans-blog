...
<img style={{ width: '100%' }} src={require('./todays_react_problem_0.png')} />
...
<img style={{ width: '100%' }} src={require('./react_class_fragmentation.jpeg')} />
...
<img style={{ width: '100%' }} src={require('./react_hooks_colocation.png')} />
